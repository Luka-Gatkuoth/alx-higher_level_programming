...
"""Define the unittests for the models/square.py.
...
class TestSquare_size(unittest.TestCase):
    """Unittests for the testing size initialization of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing initialization of Square x attributes."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initialization of Square y attributes."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests for the testing the area method of the Square class."""
