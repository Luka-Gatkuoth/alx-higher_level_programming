#!/usr/bin/python3
"""Define the unittests for base.py.
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests for the testing save_to_file method of the Base class."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Unittests for the testing load_from_file_csv method of Base class."""
